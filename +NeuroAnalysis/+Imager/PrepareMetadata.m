...
%PREPAREMETADATA Prepare Imager metadata
...
%% Prepare Imager metadata
disp('Preparing Imager Metadata:    ...');
imagermeta = [];
if ~isempty(dataset)
    imagermeta.files={dataset.filepath};
    [~, imagermeta.filename, ~] = fileparts(dataset.filepath);
    imagermeta.sourceformat = dataset.sourceformat;
end
